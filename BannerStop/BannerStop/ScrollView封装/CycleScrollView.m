...
//  Leisure
//
//  Copyright (c) 2015年 fff. All rights reserved.
//
...
-(void)setTotalPagesCount:(NSInteger)totalPagesCount {
    ...
    if (_totalPagesCount > 0) {
        [self configContentViews];
        [self.animationTimer resumeTimerAfterTimeInterval:0];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    NSLog(@"%f",contentOffsetX/CGRectGetWidth(scrollView.frame));

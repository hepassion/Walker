...
NSString *const NVViewCenterX = @"center.x";
NSString *const NVViewCenterY = @"center.y";
...
- (void)addCenterMotionEffectsXYWithOffset:(CGFloat)offset {
    ...
    xAxis = [[UIInterpolatingMotionEffect alloc] initWithKeyPath:NVViewCenterX
                                                            type:UIInterpolatingMotionEffectTypeTiltAlongHorizontalAxis];
    xAxis.maximumRelativeValue = @(offset);
    xAxis.minimumRelativeValue = @(-offset);
    
    yAxis = [[UIInterpolatingMotionEffect alloc] initWithKeyPath:NVViewCenterY

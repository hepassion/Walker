...
#import "NVJQRCodeView.h"
#import <CoreImage/CoreImage.h>

@implementation NVJQRCodeView
/**
 *  生成带logo的二维码
 *  二维码和logo都是正方形的
...
+ (NVJQRCodeView *)creatQRCodeWithURLString:(NSString *)urlString superView:(UIView *)superView logoImage:(UIImage *)logoImage logoImageSize:(CGSize)logoImageSize logoImageWithCornerRadius:(CGFloat)cornerRadius{
    // 先移除子视图
    NVJQRCodeView *oldQRCodeView = [superView viewWithTag:123];
    [oldQRCodeView removeFromSuperview];
    
    NVJQRCodeView *QRCodeView = [[NVJQRCodeView alloc] init];
    QRCodeView.tag = 123;

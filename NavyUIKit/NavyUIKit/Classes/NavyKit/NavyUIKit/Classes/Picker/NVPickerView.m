...
#define cancelBtnTag        100001
#define certainBtnTag       100002
...
- (void)setBarItemColor:(UIColor *)barItemColor{
    ...
    UIButton *cancelBtn = (UIButton *)[self.uiToolbar viewWithTag:cancelBtnTag];
    UIButton *certainBtn = (UIButton *)[self.uiToolbar viewWithTag:certainBtnTag];
    
    [cancelBtn setTitleColor:barItemColor forState:UIControlStateNormal];
    [certainBtn setTitleColor:barItemColor forState:UIControlStateNormal];
    
}

- (void)setBarItemFont:(UIFont *)barItemFont{
    _barItemFont = barItemFont;
    
    UIButton *cancelBtn = (UIButton *)[self.uiToolbar viewWithTag:cancelBtnTag];
    UIButton *certainBtn = (UIButton *)[self.uiToolbar viewWithTag:certainBtnTag];
    
    cancelBtn.titleLabel.font = barItemFont;
    certainBtn.titleLabel.font = barItemFont;

...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.uiHyperlink = [[UITextView alloc] init];
        ...
        [self.uiHyperlink addGestureRecognizer:tapRecognizer];
        self.uiHyperlink.selectable     = YES;
...
- (void) setObject:(id)object {
    ...
    self.uiImageView.frame    = CGRectMake(dataModel.frontIndentValue ? dataModel.frontIndentValue : FIT6(30),
                                           (CELL_HEIGHT2 - FIT6(36))/2,
                                           FIT6(36),
                                           FIT6(36));
    
    self.uiHyperlink.frame = CGRectMake(self.uiImageView.right + FIT6(10),
                                        0.0f,

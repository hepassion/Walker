...
@property (nonatomic, strong) NSString* rightButtonTitle;    //右侧按钮文字
@property (nonatomic, strong) UIColor*  rightButtonColor;    //右侧按钮颜色
...
@protocol NVTitleTableViewCellDelegate <NSObject>
- (void) titleTableViewCellRightButtonDidClick:(NVTitleTableViewCell *)cell;
@end
